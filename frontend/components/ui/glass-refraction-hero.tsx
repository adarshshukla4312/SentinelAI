      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <motion.div
          ...
          style={{
            ...
            top: "calc(438px - 10vh)",
            background:
              "radial-gradient(circle, #0367FE 0%, #0367FE 50%, #0256CC 100%)",
            filter: "blur(150px)",
          }}
          animate={{
            x: [0, 50, 100, 50, 0],
        ...
        <motion.div
          ...
          style={{
            ...
            top: "calc(609px - 20vh)",
            background:
              "radial-gradient(circle, #0A1DCB 0%, #0A1DCB 50%, #0816A3 100%)",
            filter: "blur(150px)",
          }}
          animate={{
            x: [0, -60, -120, -60, 0],
        ...
        <motion.div
          ...
          style={{
            ...
            top: "50%",
            background:
              "radial-gradient(circle, rgba(59, 130, 246, 0.4) 0%, rgba(59, 130, 246, 0.2) 100%)",
            filter: "blur(120px)",
                ...
                {titleWords.map((word, wordIndex) => (
                  ...
                  >
                    <span
                      ...
                      style={{
                        backgroundImage:
                          "linear-gradient(135deg, #0367FE 0%, #3b82f6 50%, #60a5fa 100%)",
              ...
              >
                {primaryAction && (
                  <button
                    ...
                    style={{
                      boxShadow:
                        "0 0 30px rgba(3, 103, 254, 0.5), 0 10px 20px rgba(0, 0, 0, 0.5)",
                    }}
...
export default GlassRefractionHero;
